...
#list of checklist column headers - shortened 10/29/18
...
def main():
	...
	err_fn = folder + 'results\\' + fn_delim.join([rundt]+params['yrs']+params['spp']+params['st']+params['cnty']+params['mon']+['err_log.csv'])
	...
	with open(fn) as f:
		for line in f:
			...
			# 	pass #skip blank lines #UNNECESSARY?
				...
				bcnty = bcntyall
				bmon = bmonall
				# print nl + 'yrsall: ' + str(byrsall) + ' : stall: ' + str(bstall) + ' : sppall: ' + str(bsppall) + ' : cntyall: ' + str(bcntyall) + ': monall: ' + str(bmonall) #TESTING
				# print nl + 'yrs: ' + str(byrs) + ' : ' + str(byrsall) + ' : ' + str(r[date_col]) + ':' + str(r[date_col][:4]) #TESTING
				...
				# print nl + 'yrs: ' + str(byrs) + ' : st: ' + str(bst) + ' : spp: ' + str(bspp) + ' : cnty: ' + str(bcnty) + ': mon: ' + str(bmon) #TESTING
				#####################################################################################
...
#						print nl + 'county: ' + str(bcnty) + ' : ' + str(bcntyall) +  ' : ' + str(r[state_col]) #TESTING
			...
			# if count>10000: break #TESTING
			# if hitcount>10: break #TESTING
			# if count<1000000:
